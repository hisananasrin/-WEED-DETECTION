...
def read_dataset(path):
    ...
    label_list = []
    i=-1
    my_list = os.listdir(r'C:\Users\hisana\PycharmProjects\weed detection\src\static\weed')
    for pa in my_list:
        i=i+1
        print(pa,"==================")
        for root, dirs, files in os.walk(r'C:\Users\hisana\PycharmProjects\weed detection\src\static\weed\\' + pa):

         for f in files:
            file_path = os.path.join(r'C:\Users\hisana\PycharmProjects\weed detection\src\static\weed\\'+pa, f)
...
# print(predict(r"C:\Users\hisana\PycharmProjects\weed detection\src\static\weed\weed\agri_0_126.jpeg"))